...
def create_path_to_upload_images(instance: 'Recipe', name: str) -> str:
    return f'images/{instance.category.name}/{name}'


class Recipe(models.Model):
    name = models.CharField(
        max_length=150, blank=False, null=False, unique=True, verbose_name='Название блюда')
    description = models.TextField(
        max_length=2000, blank=False, null=False, verbose_name='Описание блюда')
    ...
    image = models.ImageField(upload_to=create_path_to_upload_images, blank=False, null=False, verbose_name='Изображение блюда')
